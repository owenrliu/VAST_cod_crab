...
Opt$time_for_run
Report = Obj$report()
Save = list("Opt"=Opt, "Report"=Report, SDReport=SDr, "ParHat"=Obj$env$parList(Opt$opt$par), "Data"=dat, "Map"=Map)
...
load(here::here('data','VAST output',"Spatial_List.Rdata"))
...
# convergence
pander::pandoc.table(Save$Opt$opt$diagnostics[,c('Param','Lower','MLE','Upper','final_gradient')] ) 
